...
public:
    ...
    INI_API std::string Get(const std::string &section,
                            const std::string &name,
                            const std::string &default_value) const;

    // Get a string value from INI file, returning default_value if not found,
    // empty, or contains only whitespace.
    INI_API std::string GetString(const std::string &section,
                                  const std::string &name,
                                  const std::string &default_value) const;
    ...
    // "0x4d2").
    INI_API long GetInteger(const std::string &section,
                            const std::string &name,
    ...
    // according to strtod().
    INI_API double GetReal(const std::string &section,
                           const std::string &name,
    ...
    // sensitive).
    INI_API bool GetBoolean(const std::string &section,
                            const std::string &name,
