...
bool RedisServiceImpl::Init(brpc::Server &brpc_server)
{
    ...
    ns_data_table_name_ = std::make_unique<TableName>(std::string("ns_data_0"), TableType::Primary, TableEngine::EloqKv);
...
bool RedisServiceImpl::ExecuteNamespaceTxRequest(TransactionExecution *txm, TxRequest *tx_req)
{
